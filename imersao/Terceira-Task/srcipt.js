...
//for (i === 0; i < 5; i++){
    ...
    //i = console.log(parseInt(input("digite o numero: ")));
...
//3.	Faça um Programa que leia 4 notas, mostre as notas e a média na tela.
 ...
 //lista.length = console.log(input(parseInt("Digite sua nota")));

 //console.log = (lista[0] + lista[1] + lista[2] + lista[3]/4);
...
function soma(num1, num2){
    ...
    console.log("A soma entre os dois é de: " (num1 + num2))
}
